...
my.hist <- my.hist + coord_cartesian(xlim=c(0,25), ylim = c(0,175))
...
my.hist <- my.hist + scale_y_continuous( breaks = seq(0,175,by=10),expand=c(0,0))
print(my.hist)
...
my.hist.neg <- my.hist.neg + geom_histogram(aes(y=..count..),binwidth = 1,fill="black",color="black")
...
my.plot.neg.neur <- my.plot.neg.neur + labs(title="Scatterplot for Negative Affect and Neuroticism",x="Negative Affect",y="Neuroticism")
